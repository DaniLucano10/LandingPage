...
export const Homepage = () => {
    ...
    const [posicion] = useState({ x: 10, y: 150 });
    ...
    const handleClose = () => {
        setIsOpen(false);
        setFormData({ name: '', lastName: '', email: '', country: '', gender: '', occupation: '', check: '' });
        setFormErrors({});
    };
                            ...
                            <ModalContent maxWidth={900} borderRadius="none">
                                ...
                                <ModalBody pb={50} >
                                    <form onSubmit={handleSubmit}>
                                        ...
                                        <Text fontSize="sm" my={3} isInvalid={formErrors.check}
                                            name="check"
                                            value={formData.check}
                                            onchange={handleChange}>
                                            <Checkbox defaultChecked>Checkbox</Checkbox>Please check
                                            this box if you consent IE and IE Foundation to process your
                                            data (even when this is undertaken outside the EEA) and send
                                            you personalized commercial information and/or information
                                            about our activities, based on profiles created using the
                                            information obtained even by third parties, in accordance
                                        ...
                                        <Text fontSize="sm" my={3}>
                                            <Checkbox defaultChecked>Checkbox</Checkbox>Please check
                                            this box if you consent IE to contact you through text
                                            messages and messages posted on social media, even recording
                                            our conversation, to continue our commercial relation, your
                                            admission process and, where applicable, enrolment process,
